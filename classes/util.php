...
/**
 * Paddle enrolment plugin utility class.
 *
...
final class util {
     ...
     * @param \stdClass $data    Webhook data
     */
    public static function message_paddle_error_to_admin($subject, $data) {
        $admin = get_admin();
        $site = get_site();
        ...
        $eventdata->subject           = "PADDLE ERROR: ".$subject;
    ...
    public static function get_exception_handler() {
        return function($ex) {
            ...
            $logerrmsg = "enrol_paddle webhook exception handler: ".$info->message;
